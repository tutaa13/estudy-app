  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-card rounded-2xl border border-border p-5">
        <h2 className="font-semibold text-foreground mb-4">Horas estudiadas esta semana</h2>
        {weeklyHours.every(d => d.hours === 0) ? (
          <p className="text-sm text-muted-foreground text-center py-6">No hay sesiones completadas esta semana.</p>
        ) : (
      ...
      {subjectProgress.length > 0 && (
        <div className="bg-card rounded-2xl border border-border p-5">
          <h2 className="font-semibold text-foreground mb-4">Progreso por materia</h2>
      ...
      {subjectProgress.length === 0 && (
        <div className="bg-card rounded-2xl border border-dashed border-border p-10 text-center">
          <p className="text-muted-foreground text-sm">No hay materias activas para mostrar progreso.</p>
        </div>
      )}
    </div>
  )
